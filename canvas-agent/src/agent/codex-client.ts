...
export class CodexAppClient {
    ...
    static async start(emit: AgentEmit, onExit: () => void) {
        ...
        await client.request("initialize", { clientInfo: { name: "alien-ai-studio-agent", title: "Alien AI Studio Agent", version: VERSION }, capabilities: { experimentalApi: true, requestAttestation: false } });

export default {
    meta: {
        ...
        description: "AI image generation and infinite canvas creation",
    },
    ...
    modelPlugin: {
        ...
        authoring: {
            intro: "Write a model request script for Alien AI Studio. Capability: {{capability}}. Target model: {{model}}.",
    ...
    assets: {
        ...
        fields: {
            ...
            source: "Source",
            sourcePlaceholder: "Added manually / Canvas / Workbench",
            note: "Note",
            optional: "Optional",
    ...
    canvas: {
        defaultTitle: "Alien AI Studio {{count}}",
        ...
        export: { defaultProjectName: "Alien AI Studio", defaultNodesName: "Canvas elements", item: "Element" },
        createMenu: {
    ...
    config: {
        ...
        localStorage: {
            ...
            description: "View browser data saved by Alien AI Studio, grouped by object store.",
            ...
            mainDatabase: "Alien AI Studio data",
